...
class ListBoxDot extends ListBox {
  ListBoxDot({super.key, required final List<Widget> children, final GestureTapCallback? onTap, super.bgColor, super.bdColor})
    : super(
        padding: const EdgeInsets.only(left: 15.0, right: 0.0, top: 10.0, bottom: 10.0),
        children: [
          InkWell(
            onTap: onTap,
            child: Row(
...
class ListBoxDot2 extends Container {
  ListBoxDot2({super.key, required final List<Widget> children, final GestureTapCallback? onTap, Color? bgColor, Color? bdColor, EdgeInsets? padding, EdgeInsets? margin, CrossAxisAlignment? crossAxisAlignment, bool hideDot = false, MainAxisAlignment? mainAxisAlignment})
    : super(
        margin: margin ?? const EdgeInsets.only(left: 5, right: 5, top: 0, bottom: 14),

...
class KitView {
  ...
  static Future<void> alert2(
    ...
    alert(
        ...
        noCancel: cancel == null ? true : noCancel,
        alignment: alignment);
  }
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          // if(noCancel == false) KitButton(
                          //     height: 30.r,
                          //     bgColor: C.mainColor.withOpacity(0.5),
                          //     padding: EdgeInsets.symmetric(horizontal: 20.r),
                          //     name: cancelName, onTap: () async {
                          //   Navigator.pop(context);
                          //   if (cancel != null)  cancel();
                          // }),
                          // if(sure != null) KitButton(
                          //     height: 30.r,
                          //     padding: EdgeInsets.symmetric(horizontal: 20.r),
                          //     name: sureName, onTap: () async {
                          //   if (autoDismiss) Navigator.pop(context);
                          //   sure();
                          // }),
                        ],
  ...
  static String distance(int distanceInt) {
    String str = '0m';
    if (distanceInt > 100) {
      str = (distanceInt.toDouble() / 1000.0).toString().double01 + 'km';
    } else {
      str = '${distanceInt}m';
    }
    return str;

        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: const [
                BoxShadow(offset: Offset(.0, 3), blurRadius: 3.0, color: CC.fiveColor),
                BoxShadow(offset: Offset(2.0, 2), blurRadius: 2.0, color: CC.fiveColor),
              ],
            ),
            child: Center(
              child: Text(
                name,
                style: TextStyle(color: CC.lightBlack, fontSize: fontSize ?? 16.0, fontWeight: FontWeight.w700),
              ),
            ),
          ),
        ],
